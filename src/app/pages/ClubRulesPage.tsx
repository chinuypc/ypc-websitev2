...
export default function ClubRulesPage() {
  return (
    <div className="min-h-screen bg-[#1a1414] text-[#fcfcfc] overflow-x-hidden">
      <SEOHead
        title="Club Rules · YP Club"
        description="Read the rules and guidelines governing membership and participation in YP Club."
        canonical="https://ypclub.com/club-rules"
        jsonLd={[
          breadcrumbSchema([
            { name: "Home", url: "https://ypclub.com" },
            { name: "Club Rules", url: "https://ypclub.com/club-rules" },
          ]),
        ]}
      />
      <SubPageNav />
