...
export default function Typography() {
  return (
    <div className="bg-white relative rounded-[24px] size-full" data-name="Typography">
          ...
          <div className="relative shrink-0 w-full" data-name="Content">
            <div className="content-stretch flex flex-col gap-[128px] items-start pb-[96px] pt-[64px] px-[80px] relative w-full">
              <div className="content-stretch flex flex-col items-start relative shrink-0 w-[1024px]" data-name="Heading and supporting text">
                <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[90px] not-italic relative shrink-0 text-[#12131a] text-[64px] tracking-[-1.2px] whitespace-nowrap">Typography</p>
              </div>
            </div>
          </div>
        </div>
